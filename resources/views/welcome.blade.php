      ...
      <div class="container">
        ...
        <div class="row d-flex">
          ...
          <div style="width: 550px; margin-top:46px;" class="d-flex justify-content-around">
            ...
            <a href="https://instagram.com/epro.cloud?igshid=YmMyMTA2M2Y=" target="_blank" class="text-decoration-none text-muted"><ion-icon name="logo-instagram" size="small"></ion-icon></i></a>
          </div>
        </div>
        <!--row div-->
