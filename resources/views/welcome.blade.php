...
<div class="bg-primary py-5">
  <div class="container py-5 text-light">
    ...
    <a href="#" role="button" class="btn btn-warning py-2 px-3 fs-5 text-light" style="background-color:#ff8100;">Bakal Na</a>
    ...
    <div class="container py-5">
      ...
      <div class="row mt-md-5">
        ...
        <div class="col-sm-6 col-md-6 col-lg-3">
          <img class="bg rounded" src="https://bootstrap-ecommerce.com/bootstrap5-ecommerce/images/posts/1.jpg" width="250" height="200" </img>
          <div class="mt-3">
        ...
        <div class="col-sm-6 col-md-6 col-lg-3">
          <img class="bg rounded" src="https://bootstrap-ecommerce.com/bootstrap5-ecommerce/images/posts/2.jpg" width="250" height="200" </img>
          <div class="mt-3">
        ...
        <div class="col-sm-6 col-md-6 col-lg-3">
          <img class="bg rounded" src="https://bootstrap-ecommerce.com/bootstrap5-ecommerce/images/posts/3.jpg" width="250" height="200" </img>
          <div class="mt-3">
        ...
        <div class="col-sm-6 col-md-6 col-lg-3">
          <img class="bg rounded" src="https://bootstrap-ecommerce.com/bootstrap5-ecommerce/images/posts/4.jpg" width="250" height="200" </img>
          <div class="mt-3">
