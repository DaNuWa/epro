...
<head>
    ...
    <title>Job status changed </title>
        ...
        <tr>
            <td>
                <table style="background-color: #f2f3f8; max-width:670px; margin:0 auto;" width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <p style="font-size:15px; color:#455056; line-height:24px; margin:8px 0 30px;">Here's a list
                                                        of informations about the job.</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                        ...
                                                        <tr style="border-bottom:1px solid #ebebeb; margin-bottom:26px; padding-bottom:29px; display:block;">
                                                            ...
                                                            <td style="vertical-align:top;">
                                                                <h3 style="color: #4d4d4d; font-size: 20px; font-weight: 400; line-height: 30px; margin-bottom: 3px; margin-top:0;">
                                                                    <strong>Job id</strong> {{$project->id}}
                                                                </h3>
                                                            </td>
                                                        </tr>
                                                        <tr style="border-bottom:1px solid #ebebeb; margin-bottom:26px; padding-bottom:29px; display:block;">
                                                            ...
                                                            <td style="vertical-align:top;">
                                                                <h3 style="color: #4d4d4d; font-size: 20px; font-weight: 400; line-height: 30px; margin-bottom: 3px; margin-top:0;">
                                                                    <strong>Job transaction id</strong> {{$project->transaction_id}}
                                                                </h3>
                                                            </td>
                                                        </tr>
                                                        <tr style="border-bottom:1px solid #ebebeb; margin-bottom:26px; padding-bottom:29px; display:block;">
                                                            ...
                                                            <td style="vertical-align:top;">
                                                                <h3 style="color: #4d4d4d; font-size: 20px; font-weight: 400; line-height: 30px; margin-bottom: 3px; margin-top:0;">
                                                                    <strong>Job status</strong> {{$project->status}}
                                                                </h3>
                                                            </td>
                                                        </tr>
                                                    </table>
                    ...
                    <tr>
                        <td style="text-align:center;">
                            <p style="font-size:14px; color:#455056bd; line-height:18px; margin:0 0 0;">&copy; <strong>www.e-pro.cloud</strong></p>
                        </td>
                    </tr>
                    <tr>
                        <td style="height:80px;">&nbsp;</td>
